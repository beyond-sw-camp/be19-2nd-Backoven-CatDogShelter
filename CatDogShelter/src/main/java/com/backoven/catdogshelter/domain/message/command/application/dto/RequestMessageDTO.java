...
public class RequestMessageDTO {
    ...
    @Schema(description = "받을 사람이 유저인 경우 유저 번호", example = "12")
    private Integer subjectUserId;
    @Schema(description = "보낸 사람이 유저인 경우 유저 번호", example = "10")
    private Integer sendUserId;
    @Schema(description = "받은 사람이 보호소 회원인 경우 보호소 번호", example = "12")
    private Integer subjectHeadId;
    @Schema(description = "보낸 사람이 보호소 회원인 경우 보호소 번호", example = "10")
